...
map.getView().fit([-11978172.189052, 2857704.036564, -11963415.517479, 2868236.228564], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CONSTRUYENDO PAZ</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (36 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Inputs base (Técnicos y geográficos)';
            }
